...
function doGetUserMedia() {
    ...
    var constraints = {"mandatory": {}, "optional": []};  //{{ media_constraints|safe }};
    try {
...
function createPeerConnection() {
    var pc_config = {"iceServers": [{"url": "stun:stun.l.google.com:19302"}]}; //{{ pc_config|safe }};
    var pc_constraints = {"optional": [{"DtlsSrtpKeyAgreement": true}]}; //{{ pc_constraints|safe }};
...
function doCall() {
    var constraints =  {"optional": [], "mandatory": {"MozDontOfferDataChannel": true}}; //{{ offer_constraints | safe }};
