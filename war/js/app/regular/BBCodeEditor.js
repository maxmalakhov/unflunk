dojo.provide("workspace.BBCodeEditor");
...
dojo.declare("workspace.BBCodeEditor",
    ...
    {    
        ...
        templateString: "<div><span>" +
            ...
            "<span dojoType=\"dijit.Tooltip\" connectid=\"bBtn\"><b>Bold</b></span>"+
            ...
            "<span dojoType=\"dijit.Tooltip\" connectid=\"iBtn\"><i>Italic</i></span>"+
            ...
            "<span dojoType=\"dijit.Tooltip\" connectid=\"uBtn\"><u>Underline</u></span>"+
            ...
            "<span dojoType=\"dijit.Tooltip\" connectid=\"sBtn\"><s>Strikethrough</s></span>"+
            ...
            "<span dojoType=\"dijit.Tooltip\" connectid=\"supBtn\">Super<sup>script</sup></span>"+
            ...
            "<span dojoType=\"dijit.Tooltip\" connectid=\"subBtn\">Sub<sub>script</sub></span>"+
        ...
        handleButton: function(code){
            ...
            if (document.selection)    {
                ...
                sel = tan.value.substring(start, end);
