...
Worksheet.prototype.initEvent = function(board) {
    var worksheet = this;
    var events = [
        { name: "down", func: function(event) { worksheet.events.doGfxMouseDown(event); }  },
        { name: "move", func: function(event) { worksheet.events.doGfxMouseMove(event); } },
        { name: "up", func: function(event) { worksheet.events.doGfxMouseUp(event); }  }
    ];
