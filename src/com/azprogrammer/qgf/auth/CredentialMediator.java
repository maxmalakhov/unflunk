...
public class CredentialMediator {
	   ...
	   */
	  @Inject private Scopes scopes;

	  /**
	   * Loaded data from war/WEB-INF/client_secrets.json.
	   */
	  @Inject private GoogleClientSecrets secrets;
	   ...
	   */
	  @Inject private JsonFactory jsonFactory = new JacksonFactory();

	  /**
	   * HttpTransport to use for external requests.
	   */
	  @Inject private HttpTransport transport = new NetHttpTransport();
	  ...
	  private Userinfo getUserInfo(Credential credential)
	    ...
	    Oauth2 userInfoService =
	        new Oauth2.Builder(transport, jsonFactory, credential).build();
	    try {
	    ...
	    try {
	      ...
	      if ((credential == null || credential.getRefreshToken() == null)
	        ...
	        if (credential != null) {
	          ...
	          request.getSession().setAttribute("userName", userInfo.getEmail());
